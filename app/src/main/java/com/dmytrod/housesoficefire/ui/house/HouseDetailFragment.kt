 ...
 * This fragment is either contained in a [HouseListActivity]
 * in two-pane mode (on tablets) or a [HouseDetailActivity]
 * on handsets.
 */
class HouseDetailFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val rootView = inflater.inflate(R.layout.item_house_detail, container, false)
